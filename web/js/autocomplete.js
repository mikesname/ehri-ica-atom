          ...
          $('select.form-autocomplete', this).each(function ()
            {
              ...
              var input = $('<input class="' + $(this).attr('class') + '" id="' + $(this).attr('id') + '"/>').insertAfter(this)[0]
                ...
                $('option:selected', this).each(function ()
                  {
                    ...
                    $('<li><input name="' + $(select).attr('name') + '" type="hidden" value="' + $(this).val() + '"/><span>' + $(this).html() + '</span></li>')
                      .click(function ()
                        {
                          // On click, remove <li>
              ...
              else
              {
                ...
                // value,
                var hidden = $('<input name="' + $(this).attr('name') + '" type="hidden" value="' + $(this).val() + '"/>').insertAfter(this)[0];
              ...
              var autoComplete = new YAHOO.widget.AutoComplete(input, $('<div/>').insertAfter(this)[0], dataSource);
              ...
              autoComplete.itemSelectEvent.subscribe(function (type, args)
                {
                  if ($(select).attr('multiple'))
                  {
                      ...
                      .each(function ()
                        {
                          ...
                          //
                          // TODO Use CSS class
                          var span = $('span', this).css('background', 'yellow')[0];
                      ...
                      .length)
                    {
                      ...
                      // <element>
                      $('<li><input name="' + $(select).attr('name') + '" type="hidden" value="' + args[2][1] + '"/><span>' + args[2][0] + '</span></li>')
                        .click(function ()
                          {
                            // On click, remove <li>
                            $(this).hide('fast', function ()
              ...
              if (value)
              {
                ...
                function submit(event)
                {
                  ...
                  $($(components[1], iframe.contentWindow.document).val($(input).val())[0].form).submit();
                }
                    ...
                    if ($(input).val())
                    {
                      if ($(select).attr('multiple'))
                      {
                        ...
                        function submit(event)
                        {
                          ...
                          // and submit selected element's form
                          $($(components[1], iframe.contentWindow.document).val($(clone).val())[0].form).submit();
                        }
