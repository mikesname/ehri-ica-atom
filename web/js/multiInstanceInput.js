...
function multiInstanceInput(thisElement)
{
  ...
  if (lastElement.val() != '') {
    ...
    newElement.unbind();
    newElement.change(function(event) {
...
Drupal.behaviors.addMultiInstanceInput = {
  ...
  {
    $('input.multiInstance').change(function(event){
      multiInstanceInput($(this));
    });

    $('textarea.multiInstance').change(function(event){
      multiInstanceInput($(this));
    });

    $('input.multiInstanceTr').change(function(event) {
      multiInstanceInputTr($(this));
    });

    $('textarea.multiInstanceTr').change(function(event) {
      multiInstanceInputTr($(this));
    });
  }
};
