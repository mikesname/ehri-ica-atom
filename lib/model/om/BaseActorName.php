...
abstract class BaseActorName implements ArrayAccess
{
  ...
  public function __set($name, $value)
  {
    ...
    call_user_func_array(array($this->getCurrentactorNameI18n($options), '__set'), $args);
  ...
  public function __unset($name)
  {
    ...
    call_user_func_array(array($this->getCurrentactorNameI18n($options), '__unset'), $args);
