...
abstract class BaseOaiHarvest implements ArrayAccess
{
  const
    ...
    TABLE_NAME = 'q_oai_harvest',

    ID = 'q_oai_harvest.ID',
    OAI_REPOSITORY_ID = 'q_oai_harvest.OAI_REPOSITORY_ID',
    START_TIMESTAMP = 'q_oai_harvest.START_TIMESTAMP',
    END_TIMESTAMP = 'q_oai_harvest.END_TIMESTAMP',
    LAST_HARVEST = 'q_oai_harvest.LAST_HARVEST',
