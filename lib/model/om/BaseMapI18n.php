...
abstract class BaseMapI18n implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'q_map_i18n',
  ...
  {
    if (!isset(self::$mapI18ns[$key = serialize(array((int) $row[2], (string) $row[3]))]))
    {
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitMapI18n::DATABASE_NAME)->getTable(QubitMapI18n::TABLE_NAME);
  }
