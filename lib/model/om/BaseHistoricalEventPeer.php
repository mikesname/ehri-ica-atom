...
abstract class BaseHistoricalEventPeer {
  ...
  public static function getColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseHistoricalEventPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseHistoricalEventPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseHistoricalEventPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseHistoricalEventPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseHistoricalEventPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseHistoricalEventPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseHistoricalEventPeer', $c, $con);
    }
