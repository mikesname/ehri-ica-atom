...
abstract class BaseRightsTermRelation implements ArrayAccess
{
  const
    ...
    TABLE_NAME = 'rights_term_relation',

    RIGHTS_ID = 'rights_term_relation.RIGHTS_ID',
    TERM_ID = 'rights_term_relation.TERM_ID',
    TYPE_ID = 'rights_term_relation.TYPE_ID',
    DESCRIPTION = 'rights_term_relation.DESCRIPTION',
    CREATED_AT = 'rights_term_relation.CREATED_AT',
    UPDATED_AT = 'rights_term_relation.UPDATED_AT',
    ID = 'rights_term_relation.ID',
    SERIAL_NUMBER = 'rights_term_relation.SERIAL_NUMBER';
