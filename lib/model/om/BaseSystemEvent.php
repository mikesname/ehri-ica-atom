...
abstract class BaseSystemEvent implements ArrayAccess
{
  const
    ...
    TYPE_ID = 'system_event.TYPE_ID',
    OBJECT_CLASS = 'system_event.OBJECT_CLASS',
    OBJECT_ID = 'system_event.OBJECT_ID',
    PRE_EVENT_SNAPSHOT = 'system_event.PRE_EVENT_SNAPSHOT',
    POST_EVENT_SNAPSHOT = 'system_event.POST_EVENT_SNAPSHOT',
    DATE = 'system_event.DATE',
    USER_ID = 'system_event.USER_ID',
    CREATED_AT = 'system_event.CREATED_AT',
    UPDATED_AT = 'system_event.UPDATED_AT',
    ID = 'system_event.ID',
    SERIAL_NUMBER = 'system_event.SERIAL_NUMBER';
