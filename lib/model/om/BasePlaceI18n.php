...
abstract class BasePlaceI18n implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'place_i18n',

    STREET_ADDRESS = 'place_i18n.STREET_ADDRESS',
    CITY = 'place_i18n.CITY',
    REGION = 'place_i18n.REGION',
    POSTAL_CODE = 'place_i18n.POSTAL_CODE',
    ID = 'place_i18n.ID',
    CULTURE = 'place_i18n.CULTURE';
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitPlaceI18n::DATABASE_NAME)->getTable(QubitPlaceI18n::TABLE_NAME);
  }
