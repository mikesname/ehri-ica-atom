...
abstract class BaseRepositoryTermRelationshipPeer {
  ...
  public static function getColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseRepositoryTermRelationshipPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseRepositoryTermRelationshipPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseRepositoryTermRelationshipPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseRepositoryTermRelationshipPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseRepositoryTermRelationshipPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseRepositoryTermRelationshipPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseRepositoryTermRelationshipPeer', $c, $con);
    }
