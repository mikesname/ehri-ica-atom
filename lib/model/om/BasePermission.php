...
abstract class BasePermission implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'q_permission',

    MODULE = 'q_permission.MODULE',
    ACTION = 'q_permission.ACTION',
    ID = 'q_permission.ID',
    SERIAL_NUMBER = 'q_permission.SERIAL_NUMBER';
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitPermission::SERIAL_NUMBER);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitPermission::DATABASE_NAME)->getTable(QubitPermission::TABLE_NAME);
  }
