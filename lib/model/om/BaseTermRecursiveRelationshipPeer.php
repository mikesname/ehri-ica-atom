...
abstract class BaseTermRecursiveRelationshipPeer {
  ...
  public static function getColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseTermRecursiveRelationshipPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTermRecursiveRelationshipPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseTermRecursiveRelationshipPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseTermRecursiveRelationshipPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseTermRecursiveRelationshipPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseTermRecursiveRelationshipPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseTermRecursiveRelationshipPeer', $c, $con);
    }
