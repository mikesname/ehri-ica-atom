...
abstract class BaseUserTermRelationshipPeer {
  ...
  public static function getColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseUserTermRelationshipPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseUserTermRelationshipPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseUserTermRelationshipPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseUserTermRelationshipPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseUserTermRelationshipPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseUserTermRelationshipPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseUserTermRelationshipPeer', $c, $con);
    }
