...
abstract class BaseInformationObjectPeer {
	...
	const ALTERNATE_TITLE = 'information_object.ALTERNATE_TITLE';
  ...
  public static function getColumnNames()
  {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(InformationObjectPeer::ALTERNATE_TITLE);
    ...
    foreach (sfMixer::getCallables('BaseInformationObjectPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseInformationObjectPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseInformationObjectPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseInformationObjectPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseInformationObjectPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseInformationObjectPeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseInformationObjectPeer', $c, $con);
    }
