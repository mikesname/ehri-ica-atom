...
abstract class BaseActorNameI18n implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'q_actor_name_i18n',

    NAME = 'q_actor_name_i18n.NAME',
    NOTE = 'q_actor_name_i18n.NOTE',
    ID = 'q_actor_name_i18n.ID',
    CULTURE = 'q_actor_name_i18n.CULTURE',
    SERIAL_NUMBER = 'q_actor_name_i18n.SERIAL_NUMBER';
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitActorNameI18n::SERIAL_NUMBER);

    return $criteria;
  }

  protected static
    $actorNameI18ns = array();
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$actorNameI18ns[$key]))
    {
      $actorNameI18n = new QubitActorNameI18n;

      $actorNameI18n->keys = $keys;
      $actorNameI18n->row = $row;

      $actorNameI18n->new = false;
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitActorNameI18n::DATABASE_NAME)->getTable(QubitActorNameI18n::TABLE_NAME);
  }
