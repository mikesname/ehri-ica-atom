...
class ActorI18nTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addColumn('AUTHORIZED_FORM_OF_NAME', 'authorizedFormOfName', 'VARCHAR', false, 255, null);
		$this->addColumn('DATES_OF_EXISTENCE', 'datesOfExistence', 'VARCHAR', false, 255, null);
		...
		$this->addColumn('INSTITUTION_RESPONSIBLE_IDENTIFIER', 'institutionResponsibleIdentifier', 'VARCHAR', false, 255, null);
