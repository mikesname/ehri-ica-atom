...
class SearchIndex
{
  ...
  protected static function createInformationObjectDocument(QubitInformationObject $informationObject, $language, $options = array())
  {
    ...
    {
      $doc->addField(Zend_Search_Lucene_Field::Unstored('publicationStatusId', $informationObject->getStatus(array('typeId' => QubitTerm::STATUS_TYPE_PUBLICATION_ID))->statusId));
    }
    ...
    if (null !== ($digitalObject = $informationObject->getDigitalObject()))
    {
      ...
      $doc->addField(Zend_Search_Lucene_Field::Unstored('mimetype', $digitalObject->mimeType, $encoding));
    }
