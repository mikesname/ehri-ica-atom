...
<?php echo link_to_if(QubitAcl::check($resource, 'update'), '<h1 class="label">'.render_title($resource).'</h1>', array($resource, 'module' => 'donor', 'action' => 'edit'), array('title' => __('Edit donor'))) ?>
