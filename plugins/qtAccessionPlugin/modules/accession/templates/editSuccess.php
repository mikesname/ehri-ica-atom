...
<?php endif; ?>
  ...
  <?php echo render_field($form->sourceOfAcquisition
    ...
    ->label(__('Source of acquisition').' <span class="form-required" title="'.__('This is a mandatory element.').'">*</span>'), $resource, array('class' => 'resizable')) ?>
  ...
  <fieldset class="collapsible collapsed" id="administrativeArea">
    ...
    <?php echo render_field($form->archivalHistory
      ->help(__('Information on the history of the accession. When the the accession is acquired directly from the creator, do not record an archival history but record the information as the Immediate Source of Acquisition.')), $resource, array('class' => 'resizable')) ?>
