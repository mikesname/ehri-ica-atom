...
<eadid countrycode="<?php if ($object->getRepository()): ?><?php if(0 < strlen($country = $object->getRepository()->getCountryCode())): ?><?php echo $country ?><?php endif; ?><?php endif; ?>" mainagencycode="<?php if ($object->getRepository()): ?><?php if (0 < strlen($country)): ?><?php echo $country.'-' ?><?php endif; ?><?php if (0 < strlen($agency =  $object->getRepository()->getIdentifier())): ?><?php echo $agency ?><?php endif; ?><?php endif; ?>" url="<?php echo url_for(array('module' => 'informationobject', 'id' =>$object->getId(), 'sf_format' => 'xml'), $absolute = true) ?>" encodinganalog="Identifier"><?php echo $object->getId() ?></eadid>

<filedesc>
  <titlestmt>
    <?php if (0 < strlen($value = $object->getTitle(array('cultureFallback' => true)))): ?>
    <titleproper encodinganalog="Title"><?php echo htmlspecialchars($value) ?></titleproper><?php endif; ?>
    <?php if (0 < count($archivistsNotes = $object->getNotesByType(array('noteTypeId' => QubitTerm::ARCHIVIST_NOTE_ID)))): ?><?php foreach ($archivistsNotes as $note): ?><author encodinganalog="Creator"><?php echo htmlspecialchars($note) ?></author><?php endforeach; ?><?php endif; ?>
  </titlestmt>
  <?php if (0 < strlen($value = $object->getEdition(array('cultureFallback' => true)))): ?>
  <editionstmt>
    <edition><?php echo htmlspecialchars($value) ?></edition>
  </editionstmt>
  <?php endif; ?>
  <?php if ($value = $object->getRepository()): ?>
  <publicationstmt>
    ...
    <address>
      ...
      <addressline><?php echo htmlspecialchars($addressline) ?></addressline><?php endif; ?>
      <?php if (0 < strlen($addressline = $object->getRepositoryCountry())): ?>      
      <addressline><?php echo htmlspecialchars($addressline) ?></addressline><?php endif; ?>
...
<profiledesc>
  <creation><?php echo __('Generated by %1% %2%', array('%1%' => $sf_context->getConfiguration()->getApplication(), '%2%' => qubitConfiguration::VERSION)) ?>
  ...
  <?php if (0 < strlen($rules = $object->getRules(array('cultureFallback' => true)))): ?>
...
<archdesc <?php if ($object->levelOfDescriptionId):?>level="<?php if (in_array(strtolower($levelOfDescription = $object->getLevelOfDescription()->getName(array('culture' => 'en'))), $eadLevels)): ?><?php echo strtolower($levelOfDescription).'"' ?><?php else: ?><?php echo 'otherlevel" otherlevel="'.$levelOfDescription.'"' ?><?php endif; ?><?php endif; ?> relatedencoding="ISAD(G)v2">
  <did>
  <?php if (0 < strlen($value = $object->getTitle(array('cultureFallback' => true)))): ?>
  <unittitle encodinganalog="3.1.2"><?php echo htmlspecialchars($value) ?></unittitle><?php endif; ?>
  <?php if (0 < strlen($object->getIdentifier())): ?><unitid <?php if ($object->getRepository()): ?><?php if ($repocode = $object->getRepository()->getIdentifier()): ?><?php echo 'repositorycode="'.htmlspecialchars($repocode).'" ' ?><?php endif; ?><?php if ($countrycode = $object->getRepository()->getCountryCode()): ?><?php echo 'countrycode="'.$countrycode.'"' ?><?php endif;?><?php endif; ?> encodinganalog="3.1.1"><?php echo htmlspecialchars(QubitIsad::getReferenceCode($object)) ?></unitid><?php endif; ?>
  ...
  <?php if (0 < count($creators = $object->getCreators())): ?>
  ...
  <?php if (0 < strlen($value = $object->getExtentAndMedium(array('cultureFallback' => true)))): ?>
  <physdesc><extent encodinganalog="3.1.5"><?php echo htmlspecialchars($value) ?></extent></physdesc><?php endif; ?>
  <?php if ($value = $object->getRepository()): ?>
  <repository>
  ...
  <?php if (0 < count($langmaterial = $object->language)): ?>
  ...
  <?php if (0 < count($notes = $object->getNotesByType(array('noteTypeId' => QubitTerm::GENERAL_NOTE_ID)))): ?><?php foreach ($notes as $note): ?><note type="<?php echo htmlspecialchars($note->getType(array('cultureFallback' => true))) ?>" encodinganalog="3.6.1"><p><?php echo htmlspecialchars($note->getContent(array('cultureFallback' => true))) ?></p></note><?php endforeach; ?><?php endif; ?>
  </did>
  <?php foreach ($object->getCreators() as $creator): ?>
    <?php if ($value = $creator->getHistory(array('cultureFallback' => true))): ?>
  <bioghist encodinganalog="3.2.2"><p><?php echo htmlspecialchars($value) ?></p></bioghist><?php endif; ?><?php endforeach; ?>
  <?php if (0 < strlen($value = $object->getScopeAndContent(array('cultureFallback' => true)))): ?>
  <scopecontent encodinganalog="3.3.1"><p><?php echo htmlspecialchars($value) ?></p></scopecontent><?php endif; ?>
  <?php if (0 < strlen($value = $object->getArrangement(array('cultureFallback' => true)))): ?>  
  <arrangement encodinganalog="3.3.4"><p><?php echo htmlspecialchars($value) ?></p></arrangement><?php endif; ?>
  <?php if ((0 < count($materialtypes = $object->getMaterialTypes())) ||
            (0 < count($subjects = $object->getSubjectAccessPoints())) ||
            (0 < count($places = $object->getPlaceAccessPoints())) || 
            (0 < count($object->getActors()))): ?>
  <controlaccess>
  <?php foreach ($object->getActorEvents() as $event): ?>
  ...
  <?php endif; ?>
  <?php if (0 < strlen($value = $object->getPhysicalCharacteristics(array('cultureFallback' => true)))): ?>
  <phystech encodinganalog="3.4.3"><p><?php echo htmlspecialchars($value) ?></p></phystech><?php endif; ?>
  <?php if (0 < strlen($value = $object->getAppraisal(array('cultureFallback' => true)))): ?>
  <appraisal encodinganalog="3.3.2"><p><?php echo htmlspecialchars($value) ?></p></appraisal><?php endif; ?>
  <?php if (0 < strlen($value = $object->getAcquisition(array('cultureFallback' => true)))): ?>
  <acqinfo encodinganalog="3.2.4"><p><?php echo htmlspecialchars($value) ?></p></acqinfo><?php endif; ?>
  <?php if (0 < strlen($value = $object->getAccruals(array('cultureFallback' => true)))): ?>
  <accruals encodinganalog="3.3.3"><p><?php echo htmlspecialchars($value) ?></p></accruals><?php endif; ?>
  <?php if (0 < strlen($value = $object->getArchivalHistory(array('cultureFallback' => true)))): ?>
  <custodhist encodinganalog="3.2.3"><p><?php echo htmlspecialchars($value) ?></p></custodhist><?php endif; ?>
  <?php if (0 < strlen($value = $object->getRevisionHistory(array('cultureFallback' => true)))): ?>  
  <processinfo><p><?php echo htmlspecialchars($value) ?></p></processinfo><?php endif; ?>
  <?php if (0 < strlen($value = $object->getLocationOfOriginals(array('cultureFallback' => true)))): ?>
  <originalsloc encodinganalog="3.5.1"><p><?php echo htmlspecialchars($value) ?></p></originalsloc><?php endif; ?>
  <?php if (0 < strlen($value = $object->getLocationOfCopies(array('cultureFallback' => true)))): ?>
  <altformavail encodinganalog="3.5.2"><p><?php echo htmlspecialchars($value) ?></p></altformavail><?php endif; ?>
  <?php if (0 < strlen($value = $object->getRelatedUnitsOfDescription(array('cultureFallback' => true)))): ?>
  <relatedmaterial encodinganalog="3.5.3"><p><?php echo htmlspecialchars($value) ?></p></relatedmaterial><?php endif; ?>
  <?php if (0 < strlen($value = $object->getAccessConditions(array('cultureFallback' => true)))): ?>
  <accessrestrict encodinganalog="3.4.1"><p><?php echo htmlspecialchars($value) ?></p></accessrestrict><?php endif; ?>  
  <?php if (0 < strlen($value = $object->getReproductionConditions(array('cultureFallback' => true)))): ?>
  <userestrict encodinganalog="3.4.2"><p><?php echo htmlspecialchars($value)  ?></p></userestrict><?php endif; ?>
  <?php if (0 < strlen($value = $object->getFindingAids(array('cultureFallback' => true)))): ?>
  <otherfindaid encodinganalog="3.4.5"><p><?php echo htmlspecialchars($value) ?></p></otherfindaid><?php endif; ?>
  <?php if (0 < count($publicationNotes = $object->getNotesByType(array('noteTypeId' => QubitTerm::PUBLICATION_NOTE_ID)))): ?><?php foreach ($publicationNotes as $note): ?><bibliography encodinganalog="3.5.4"><p><?php echo htmlspecialchars($note) ?></p></bibliography><?php endforeach; ?><?php endif; ?>

    <dsc type="combined"><?php $nestedRgt = array() ?><?php foreach ($object->getDescendants()->orderBy('lft') as $descendant): ?>
    ...
    <phystech encodinganalog="3.4.4"><p><?php echo htmlspecialchars($value) ?></p></phystech><?php endif; ?>
    ...
    <processinfo><p><?php echo htmlspecialchars($value) ?></p></processinfo><?php endif; ?>
    <?php if (0 < count($archivistsNotes = $descendant->getNotesByType(array('noteTypeId' => QubitTerm::ARCHIVIST_NOTE_ID)))): ?><?php foreach ($archivistsNotes as $note): ?><processinfo><p><?php echo htmlspecialchars($note) ?></p></processinfo><?php endforeach; ?><?php endif; ?>
    ...
    <otherfindaid encodinganalog="3.4.5"><p><?php echo htmlspecialchars($value) ?></p></otherfindaid><?php endif; ?>
    <?php if (0 < count($publicationNotes = $descendant->getNotesByType(array('noteTypeId' => QubitTerm::PUBLICATION_NOTE_ID)))): ?><?php foreach ($publicationNotes as $note): ?><bibliography encodinganalog="3.5.4"><p><?php echo htmlspecialchars($note) ?></p></bibliography><?php endforeach; ?><?php endif; ?>
