...
<?php endif; ?>
  ...
  <fieldset class="collapsible collapsed" id="descriptionControlArea">
    ...
    <?php foreach ($isdiah->commonSources as $source): ?>
        ...
        <label style="display:inline;" for="descSource_<?php echo $sourcerow ?>"><?php echo $source ?></label><br />
        <?php $sourcerow++ ?>
    <?php endforeach ?> 
    <label for="otherSources">Other Sources (one per line)</label>
    <textarea rows="4" cols="30" name="otherSources" class="resizable textarea-processed" id="otherSources" style=""></textarea>
  </div>
