...
<?php endif; ?>
  ...
  <fieldset class="collapsible collapsed" id="notesArea">
    ...
    <?php echo $form->script
      ->help(__('"[N]ote any distinctive alphabets or symbol systems employed." (RAD 1.8.B14) Select the script from the drop-down menu; enter the first few letters to narrow the choices.'))
      ->renderRow(array('class' => 'form-autocomplete')) ?>
