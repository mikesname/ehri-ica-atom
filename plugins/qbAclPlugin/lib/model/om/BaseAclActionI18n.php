...
abstract class BaseAclActionI18n implements ArrayAccess
{
  const
    ...
    SERIAL_NUMBER = 'q_acl_action_i18n.SERIAL_NUMBER';
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitAclActionI18n::SERIAL_NUMBER);
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$aclActionI18ns[$key]))
    {
      $aclActionI18n = new QubitAclActionI18n;

      $aclActionI18n->keys = $keys;
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitAclActionI18n::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitAclActionI18n', $options);
  }
  ...
  public static function doDelete(Criteria $criteria, $connection = null)
  {
    if (!isset($connection))
    {
      $connection = QubitTransactionFilter::getConnection(QubitAclActionI18n::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitAclActionI18n::DATABASE_NAME)->getTable(QubitAclActionI18n::TABLE_NAME);
  }
