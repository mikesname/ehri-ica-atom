...
class myUser extends sfBasicSecurityUser
{
  ...
  public function signIn($user)
  {
    ...
    foreach ($user->getUserCredentials() as $credential)
      {
      $this->addCredential($credential['credential']);
      $this->setAttribute($credential['credential'].'-'.$credential['repositoryId'], $credential['repository'],'credentialScope');
      }
  ...
  {
    $user = UserPeer::retrieveByPk($this->getAttribute('user_id'));
