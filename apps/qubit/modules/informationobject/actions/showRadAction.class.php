...
class InformationObjectShowRadAction extends InformationObjectShowAction
{
  public function execute($request)
  {
    ...
    $this->notes = $this->informationObject->getNotesByTaxonomy($options = array('taxonomyId' => QubitTaxonomy::RAD_NOTE_ID));
    $this->titleNotes = $this->informationObject->getNotesByTaxonomy($options = array('taxonomyId' => QubitTaxonomy::RAD_TITLE_NOTE_ID));
  }
}
