...
class deleteActorRelationshipAction extends sfAction
{
  ...
  $informationObjectId = $this->deleteActorRelationship->getInformationObjectId();

  $this->deleteActorRelationship->delete();
