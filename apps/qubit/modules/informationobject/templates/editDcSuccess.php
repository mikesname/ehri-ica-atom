...
<?php echo form_tag('informationobject/updateDc') ?>
  ...
  <?php endif; ?>
    ...
    <div class="form-item">
      ...
      <?php foreach ($languageCodes as $languageCode): ?>
        ...
        <?php echo format_language($languageCode->getValue()) ?>&nbsp;<?php echo link_to(image_tag('delete', 'align=top'), 'actor/deleteProperty?Id='.$languageCode->getId().'&returnTemplate=editDc') ?><br/>
        </div>
      <?php endforeach; ?>
    ...
    <div class="form-item">
      ...
      <?php foreach ($subjectAccessPoints as $subject): ?>
        <?php echo $subject->getTerm() ?>&nbsp;<?php echo link_to(image_tag('delete', 'align=top'), 'informationobject/deleteTermRelation?TermRelationId='.$subject->getId().'&returnTemplate=dc') ?><br/>
      <?php endforeach; ?>
