...
<ul class="error-list">
  ...
  <li>
    <?php if ($error == 'no_form_data'): ?>
      <?php echo __('Error! The update form contained no post data.  This error may be a result of attempting to upload a file that exceeds the max POST size of %1%.',
        array('%1%' => ini_get('post_max_size'))); ?>
    <?php endif; ?>
  </li>
  <?php endforeach; ?>
</ul>
