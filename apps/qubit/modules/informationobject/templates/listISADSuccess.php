...
<tr>
  ...
  <th><?php if ($sort == 'repositoryUp'): ?>
    <?php echo link_to(__('archival institution'), 'informationobject/list?repository='.$repository.'&sort=repositoryDown') ?>
    <?php echo image_tag('up.gif', 'style="padding-bottom: 3px;"', 'sort up') ?>
  <?php else: ?>
    <?php echo link_to(__('archival institution'), 'informationobject/list?repository='.$repository.'&sort=repositoryUp') ?>
  <?php endif; ?>
