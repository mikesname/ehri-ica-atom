THIS TEMPLATE IS A WORK IN PROGESS. IT'S AN ISAD TEMPLATE THAT WILL BE CONVERTED TO A MODS TEMPLATE.
...
<?php if($informationObject->getAlternateTitle()) : ?>
<tr>
<th><?php echo __('subtitle'); ?>: </th>
<td><?php echo $informationObject->getAlternateTitle(); ?></td>
</tr>
<?php endif; ?>
...
<tr><th><?php echo __('date created'); ?>: </th><td>
