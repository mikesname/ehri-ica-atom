   ...
   <div class="form-item">
      ...
      <?php if (count($contactInformation) > 0): ?>
        <?php foreach ($contactInformation as $contact): ?>
          ...
          <?php echo link_to(image_tag('delete', 'align=top'), 'actor/deleteContactInformation?contactInformationId='.$contact->getId().'&returnTemplate=isdiah') ?>
          </td></tr></table>
...
<div id="button-block">
  ...
  <div class="menu-action">
    <?php if ($repository->getId()): ?>
      ...
      &nbsp;<?php echo link_to(__('cancel'), 'repository/showIsdiah?id='.$repository->getId()) ?>
    <?php else: ?>
