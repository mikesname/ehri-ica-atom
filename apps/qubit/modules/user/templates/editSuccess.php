<div class="pageTitle"><?php echo __('edit').' '.__('user'); ?></div>
...
<tr><td colspan="2" class="headerCell"><?php echo link_to($user->getUserName().' '.__('profile'), 'user/show?id='.$user->getId()) ?></td></tr>
<tr>
